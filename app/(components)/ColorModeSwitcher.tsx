...
export default function ColorModeSwitcher({width} : {width?: number}) {
  if(!width) width = 6
  ...
  return (
      <label className="swap swap-rotate mx-4">
          ...
          <svg className={`swap-off fill-current w-${width} h-${width}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" onClick={toggleMode}>
